...
// 表格
	...
	$("#search_btn").click(function(){
		...
		var hh = $('#hh').val();
		var sfjf=$('#sfjf').val();
		compareWord(xq,ld,dy,hh,sfjf,compareWordList);
    ...
    function tableToExcel(){
        ...
        '<td>室外温度</td><td>管道温度</td><td>锁定</td><td>采集器安装时间</td>'+
        '<td>抄表时间</td><td>用户ID</td>'+
        '<td>阀门地址</td><td>传感器地址</td><td>安装位置</td><td>缴费状态</td><td>电话号码</td>'+
        '<td>面积</td><td>区管ID</td>'+
        '</tr>';
...
function compareWord(xq,ld,dy,hh,sfjf,compareWordList){
