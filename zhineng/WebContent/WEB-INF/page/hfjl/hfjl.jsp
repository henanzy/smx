...
var list;
$.ajax({
		url : "<%=basePath%>kfCon/findhfjl.action", 
		async : false,
		dataType : "json",
		data : {
    ...
    <div id="" class="clearfix">
                        ...
                        <table class="mws-table" >
                            <thead >
                                <tr>
                                    ...
                                    <th class="table-th-css">回访类型</th>
                                    <th class="table-th-css">回访目的</th>
                                    <th class="table-th-css">回访结果</th>
                                    <th class="table-th-css">回访人</th>
                                    <th class="table-th-css">回访时间</th>
        ...
        <div id="increase_word">
			<div class="mws-panel grid_4"
				...
				<div class="mws-panel-body" style="height: 450px;">
					<form class="mws-form" id="insert" action="InsertHf.action" method="post">
						<div class="mws-form-inline">
						<div class="mws-form-row">
								<label>&emsp;回访人：</label>

								<div class="mws-form-item large">
								 <input type="text" class="mws-textinput increase_word_input" 
										name="hfr" value="" width="50px" />
								</div>
						</div>
						<div class="mws-form-row">
						...
						<div class="mws-form-row">
							...
							<div class="mws-form-row">
								<label>&emsp;回访类型：</label>

									<select style="height:40px;width:250px" id="hflx" name="hflx">
							      <option value="上门回访" >--上门回访--</option>
							      <option value="电话回访" >--电话回访--</option>
					            </select>
							</div>	
									<div class="mws-form-row">
								<label>&emsp;回访目的：</label>
		...
		<div id="change_word">
			<div class="mws-panel grid_4"
				...
				<div class="mws-panel-body" style="height: 450px;">
					<form class="mws-form" id="update" action="Updatehfjl.action" method="post">
						<div class="mws-form-inline">
						...
						<div class="mws-form-row">
								...
								<input type="text" class="mws-textinput change_word_input" 
										name="XqName" id="hh2" value="" autofocus="autofocus" />
								</div>
						</div>
						<div class="mws-form-row">
								<label>&emsp;楼栋号：</label>
								...
								<div class="mws-form-item large">
								<input type="text" class="mws-textinput change_word_input" 
										name="BuildNO" id="hh2" value="" autofocus="autofocus" />
								</div>
						</div>
						<div class="mws-form-row">
								<label>&emsp;单元号：</label>
								...
								<div class="mws-form-item large">
									<input type="text" class="mws-textinput change_word_input" 
										name="CellNO" id="hh2" value="" autofocus="autofocus" />
								</div>
						</div>
						...
						<div class="mws-form-row">
							...
							<div class="mws-form-row">
								...
								<div class="mws-form-item large">
									<input type="text" class="mws-textinput change_word_input" 
										name="hflx" id="hflx" value="" autofocus="autofocus" />
								</div>
							</div>	
							...
							<div class="mws-form-row">
								...
								<div class="mws-form-item large">
									<input type="text" class="mws-textinput change_word_input" 
										name="hfmd" value="" autofocus="autofocus" />
								</div>
							</div>
							<div class="mws-form-row">
								<label>&emsp;回访结果：</label>
								...
								<div class="mws-form-item large">
									<input type="text" class="mws-textinput change_word_input" 
										name="hfjg" value="" autofocus="autofocus" />
								</div>
							</div>
						   <div class="mws-form-row">
								<label>&emsp;回访人：</label>
								...
								<div class="mws-form-item large">
									<input type="text" class="mws-textinput change_word_input" 
										name="hfr" value="" autofocus="autofocus" />
								</div>
							</div>
						</div>
...
<script type="text/javascript" src="../js/hfjl.js"></script>
