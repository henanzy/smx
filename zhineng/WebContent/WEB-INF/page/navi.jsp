	...
	<body>
		...
		<div id="overall">
			...
			<div id="leftcontent">
				...
				<div class="main_left">
					<p><label>换热站：</label><span class="span_num">103</span> <span class="span_nuit">座</span></p>
					<p><label>智慧供热用户：</label><span class="span_num">16425</span>  <span class="span_nuit">户</span></p>
					<p><label>热计量用户：</label><span class="span_num">7450</span> <span class="span_nuit">户</span></p>
					<p><label>其他用户：</label><span class="span_num">68137</span> <span class="span_nuit">户</span></p>
					<p><label>平均室温：</label><span class="span_num">20.3</span>  <span class="span_nuit">°C</span></p>
					<p><label>室外温度：</label><span class="span_num">9.2</span>  <span class="span_nuit">°C</span></p>
					<p><label>安全运行时间：</label><span class="span_num">843</span>  <span class="span_nuit">天</span></p>
				</div>
			...
			<div id="rightupcontent">
				...
				<div class="main_rightup">
					...
					<p><label>目标能耗：</label><span class="span_num">0.37</span>  <span class="span_nuit"></span></p>
					<p><label>当前平均能耗：</label><span class="span_num">0.395</span> <span class="span_nuit"></span></p>
					<p><label>指标剩余热量：</label><span class="span_num">61563</span> <span class="span_nuit">GJ</span></p>
					<div id="disnum">
						<span class="disimg"><img src="../images/num/7.png" /></span>
						<span class="disimg"><img src="../images/num/8.png" /></span>
						<span class="disimg"><img src="../images/num/4.png" /></span>
			...
			<div id="rightdowncontent">
				...
				<ul id="demo_menu1" class="sidebar-menu">
					  <li style="margin-left: 0px;"><a
						href="<%=ip%>/xingxhrz/user/home.action?type=<%=request.getSession().getAttribute("type")%>&gs=<%=request.getSession().getAttribute("gs")%>&UserName=<%=request.getSession().getAttribute("UserName")%>">换热站管理</a></li>
						<li style="margin-left: 0px;"><a
						href="<%=basePath%>user/home.action?fl=nhjk&type=<%=request.getSession().getAttribute("type")%>">智能入户</a></li>
						<li style="margin-left: 0px;"><a
						href="<%=ip%>RbHotPower/UserCon/index.action?userRole=1001&userName=<%=request.getSession().getAttribute("UserName")%>&UserName=<%=request.getSession().getAttribute("UserName")%>">热表集抄</a></li>
					<li style="margin-left: 0px;"><a
						href="<%=ip%>/kefu/user/home.action?type=<%=request.getSession().getAttribute("type")%>&gs=<%=request.getSession().getAttribute("gs")%>&UserName=<%=request.getSession().getAttribute("UserName")%>">客服管理</a></li>
					<li style="margin-left: 0px;"><a
