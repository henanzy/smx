	...
	<body>
		...
		<div id="overall">
			...
			<div id="leftcontent">
				...
				<div class="main_left">
					<p><label>换热站：</label><span class="span_num">292</span> <span class="span_nuit">座</span></p>
					<p><label>智慧供热用户：</label><span class="span_num">35343</span>  <span class="span_nuit">户</span></p>
					...
					<p><label>平均室温：</label><span class="span_num" id="pjsw"></span>  <span class="span_nuit">°C</span></p>
			...
			<div id="rightupcontent">
				...
				<div class="main_rightup">
					...
					<p><label>指标剩余热量：</label><span class="span_num">116290</span> <span class="span_nuit">GJ</span></p>
					<div id="disnum">
					    <span class="disimg"><img src="../images/num/1.png" /></span>
			...
			<div id="rightdowncontent">
				...
				<ul id="demo_menu1" class="sidebar-menu">
					  <li id="hrz" style="margin-left: 0px;"><a
					...
					<li id="kf" style="margin-left: 0px;"><a
					...
					<li id="jf" style="margin-left: 0px;"><a
						...
						<li id="rz" style="margin-left: 0px;"><a
		...
		$.ajax({
			url :  getRootPath()+"/user/getRoleIdByName.action", 
			async : false,
			dataType : "json",
			data : {
				name:"换热站登录",
