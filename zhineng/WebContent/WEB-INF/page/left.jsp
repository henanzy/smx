...
function qxfp(){// 
    window.open("<%=basePath%>user/qxfp.action","Conframe");
}
/* 知识库 */
function qiytl(){// 
...
function history(){
    ...
    window.open("<%=basePath%>YxglCon/history.action","Conframe");
}
//工单详情
function gdxq(){
	   window.open("<%=basePath%>YxglCon/gdxq.action","Conframe");
}
function add(){// 
	window.open("<%=basePath%>user/xzyh.action","Conframe");
}	

function hfjl(){
	  window.open("<%=basePath%>kfCon/hfjl.action","Conframe");	
			...
			<ul>
				...
				<li class="active"><a href="#" class="mws-i-24 i-cassette">智能锁闭阀</a>
					<ul class="ac_kf">
						...
						<li><a class="taglist" onclick="qxfp()" target="Conframel">&nbsp;&nbsp;&nbsp;&nbsp;权限分配</a></li>
						<li><a class="taglist" onclick="role()" target="Conframel">&nbsp;&nbsp;&nbsp;&nbsp;用户管理</a></li>
						<li><a class="taglist" onclick="add()" target="Conframel">&nbsp;&nbsp;&nbsp;&nbsp;用户注册</a></li>
						 </c:if> 
								</ul>
						</c:if>
					</ul></li>
				<c:if test="${fl=='nhjk'}">
					<li class="active"><a href="#"
						...
						<ul class="ac_kf">
							...
							<li><a class="taglist" onclick="hfjl()" target="Conframel">&nbsp;&nbsp;&nbsp;&nbsp;回访记录</a></li>
							<li><a class="taglist" onclick="history()" target="Conframel">&nbsp;&nbsp;&nbsp;&nbsp;历史数据</a></li>
							<li><a class="taglist" onclick="gdxq()" target="Conframel">&nbsp;&nbsp;&nbsp;&nbsp;安装记录</a></li>
