...
<script type="text/javascript" src="../js/yxsj.js"></script>
<style type="text/css">
.span-up{
        border-style: solid;
...
<script>
    $(document).ready(function(){
		var displaytableCont = $('#display_table_body table tr th'); //获取th
		var displaytableScroll = $('#display_table_body'); //获取滚动条同级
		displaytableScroll.on('scroll', scrollHandledisplay);
		
		function scrollHandledisplay() {
			var scrollTop = displaytableScroll.scrollTop();
			// 当滚动距离大于0时设置top及相应的样式
			if (scrollTop > 0) {
				displaytableCont.css({
					"top" : scrollTop + 'px',
					"marginTop" : "-1px",
...
<body>
	<div id="" class="clearfix">
		...
		<div class="mws-report-container clearfix">
			...
			<p class="mws-report" href="#" style="font-size: 14px; height:120px !important;">
				...
				<span class="mws-report-title"> 选择小区 
					...
					<span>楼栋号：
						<select name="ldh" id="ldh" style="width:100px">
							<option value="" >楼栋</option>
					</select>
					</span>
					<span>单元号：
						<select name="dyh" id="dyh" style="width:100px">
							<option value="" >单元</option>
					</select>
					</span>
					
					户号：<input type="text" name="hh" id="hh" size=5px
						value="" style="height:24px" /> &nbsp;&nbsp;&nbsp; 
					

				</span>
				<select id="sfjf">
					<option value="">-缴费-</option>
					<option value="是" selected="selected">-是-</option>
					<option value="否">-否-</option>
					</select>
				</span>
				<!--  ------分开线------- -->
				<span class="mws-report-content"> <span
					class="mws-report-title"> 
					<label for="readMTime">室内温度:</label>
						<inputstyle="height:24px"  type="text" name="valTemp" size="4px" id="snwd_start"
						value="" /> ℃ — <input type="text" name="valTemp" size="5px"
						id="snwd_end" value="" style="height:24px" /> ℃ &nbsp;&nbsp;&nbsp; 
						
						<label
						for="readMTime">管道温度:</label> <input style="height:24px" type="text" name="valTemp"
						size="5px" id="gdwd_start" value="" /> ℃ — <input type="text"
						name="valTemp" style="height:24px" size="4px" id="gdwd_end" value="" /> ℃
						&nbsp;&nbsp;&nbsp; 
						
						
						<label for="readMTime">阀门开度:</label> <input style="height:24px"
						type="text" name="valTemp" size="4px" id="fmkd_start" value="" />
						% — <input type="text" style="height:24px" name="valTemp" size="4px" id="fmkd_end"
						value="" /> %
		...
		<div class="mws-panel grid_8">
			...
			<div id="display_table_body" class="mws-panel-body"
				...
				<table class="mws-table" >
					<thead>
						<tr>
							...
							<th class="table-th-css">阀门ID<span class="span-up"></span> <span class="span-down"></span></th>
							<th class="table-th-css">传感器ID<span class="span-up"></span> <span class="span-down"></span></th>
