...
<script>
    $(document).ready(function(){
		var slotcardtableCont = $('#slotcard_table_body table tr th'); //获取th
		var slotcardtableScroll = $('#slotcard_table_body'); //获取滚动条同级
		slotcardtableScroll.on('scroll', scrollHandleslotcard);
		
		function scrollHandleslotcard() {
			var scrollTop = slotcardtableScroll.scrollTop();
			// 当滚动距离大于0时设置top及相应的样式
			if (scrollTop > 0) {
				slotcardtableCont.css({
					"top" : scrollTop + 'px',
					"marginTop" : "-1px",
...
<body>
	<div id="" class="clearfix">
			...
			<p class="mws-report" href="#" style="font-size: 14px;height:80px !important;">
				...
				<span>选择公司：
				 ...
				 选择小区 	
					...
					户号<input type="text" name="hh" id="hh" size=6px style="height:24px"
						value="" /> &nbsp;&nbsp;&nbsp; 
					</span>
					<span class="mws-report-title">
					<span class="mws-report-title"> 
					...
					<span class="mws-report-title"> 
						<input type="submit"
						class="mws-button black" id="search_btn" value="搜索" /> <input type="submit"
						class="mws-button black" id="export_btn" value="导出" />
							</span>
						</span>
		...
		<div class="mws-panel grid_8">
			...
			<div id="slotcard_table_body" class="mws-panel-body"
				style="width: 99.5%; height:580px; overflow: auto;">

				<table class="mws-table">
					<thead>
						<tr>
							<th class="table-th-css">设备号<span class="span-up"></span> <span class="span-down"></span></th>
							<th class="table-th-css">卡号<span class="span-up"></span> <span class="span-down"></span></th>
							<th class="table-th-css">阀门状态<span class="span-up"></span> <span class="span-down"></span></th>
							<th class="table-th-css">刷卡状态<span class="span-up"></span> <span class="span-down"></span></th>
...
<script type="text/javascript" src="../js/skjl.js"></script>
</html>