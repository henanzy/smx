                	...
                	<p class="mws-report" href="#" style="font-size: 14px;"> 
                        ...
                        <span class="mws-report-content" style="margin-top: 5px;">
                        	<span class="mws-report-title" >
	                                                          操作人:<input type="text" name="houseNo" id="czr" size=10px value=""   style="height:24px"/> &nbsp;&nbsp;&nbsp;
	                                                          操作内容模糊查询:<input type="text" name="houseNo" id="cz" size=6px value="" style="height:24px" /> &nbsp;&nbsp;&nbsp;
                                </span>
                          </span>
                           ...
                           <span class="mws-report-content">
                             <span class="mws-report-title" >
                                 <label for="readMTime">选择时间:</label>
		 						 <input type="text" id="recordTime1" style="height:24px" name="recordTime1" id="startTime" class="startTime" onfocus="WdatePicker();" />
								-<input type="text" id="recordTime2" style="height:24px"  name="recordTime2" id="endTime" class="endTime" onfocus="WdatePicker();" />	
