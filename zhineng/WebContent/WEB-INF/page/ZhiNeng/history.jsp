...
<div class="mws-panel grid_8 "
			style="width: 118%; padding-left: 10px; margin: 0px 0px 10px 0px; min-width:950px">
			...
			<div class="search">
				...
				开始时间:<input type="date" id="startTime"  style="width:140px" value="" />-
                                              结束时间:<input type="date" id="endTime" style="width:140px" value="" />
...
<%--  $.ajax({
 ...
 $.ajax({
 		url : "<%=basePath%>yhInfo/SeaHistoryTop.action", 
 		async : false,
 		dataType : "json",
 		data : {
 			"xqName":$("#xq").val(),
