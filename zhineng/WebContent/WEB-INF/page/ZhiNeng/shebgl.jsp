...
<div id="progressBar" class="progressBar pro" >数据加载中，请稍等...</div> 
    <div id="" class="clearfix">
            	...
            	<div class="mws-report-container clearfix" style="margin:1px;">
				    ...
				    <span>选择公司：
					<select id="ssgs" style="width:85px"
						name="ssgs">
					...
					<span>楼栋号：
						<select name="ldh" id="ldh" style="width:60px">
							<option value="" >楼栋</option>
					</select>
					</span>
					<span>单元号：
						<select name="dyh" id="dyh" style="width:60px">
                         ...
                         <!--  ------分开线------- -->
                          <span class="mws-report-content"  > 
                             <span class="mws-report-title" >
	                                                              ...
	                                                              传感器地址：<input type="text" name="" id="Cgqdz" size=8px value="" onblur="isIntNum()"  />&nbsp;
						    	<input type="submit" id="xgcgq" class="mws-button black"  value="修改传感器地址"/>
                                                                             调节周期：<input type="text" id="wdsd" name="wdsd" size=4px value="6"/>
                                                                             室温设定：<input type="text" id="tjzq" name="tjzq" size=4px value="21"/>
                                                                             调节参数：<input type="text" id="tjcs" name="tjcs" size=4px value="153"/>
                                                                             锁定标识：<select name="sdbs" id="sdbs">
                                 		<option value="FF">锁定标识</option>
                          ...
                          <span class="mws-report-content"  >
                             ...
                             <span class="mws-report-title" >
                                                                         阀门开度设置：<input type="text" size="4px" id="fmkd" name="fmkd"/>&nbsp;&nbsp;
                                         ...
                                         <button type="button"id="dcgq"  class="mws-button black" >读传感器地址</button>&nbsp;
                           				 ...
                           				 <option value="特殊用户">特殊用户</option>
                           				 </select>
                           			 <button type="button"id="change_zdjk"  class="mws-button black" >修改用户类型</button>&nbsp;
                                          <select id="yhlbs">
                           				 <option value="重点监控">重点监控</option>
                           				 <option value="退费停暖">退费停暖</option>
                           				 <option value="特殊用户">特殊用户</option>
                           				 </select>
                           				 <button type="button"id="sel_zdjk"  class="mws-button black" >搜索</button>&nbsp;
     	  	...
     	  	<div class="mws-panel grid_8" >
                    ...
                    <div id="sheb_table_body" class="mws-panel-body" style="width:99.5%; height:580px; overflow:scroll;">
