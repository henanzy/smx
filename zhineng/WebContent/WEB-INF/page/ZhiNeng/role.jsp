...
$.ajax({
		url : "<%=basePath%>ZskCon/selUser.action", 
		async : false,
		dataType : "json",
		data : {
                        ...
                        <table class="mws-table" >
                            <thead >
                                <tr>
                                    ...
                                    <th class="table-th-css">账号名</th>                                  
                                    <th class="table-th-css">角色</th>
                                    <th class="table-th-css">角色编码</th>
        ...
        <div id="change_word">
			<div class="mws-panel grid_4"
				...
				<div class="mws-panel-header">
					<span class="mws-i-24 i-pencil">修改角色</span> <span class="close"></span>
				</div>
				<div class="mws-panel-body" style="height: 120px;">
					<form class="mws-form" action="updateUser.action"  method="post">
						...
						<div class="mws-form-row">
								...
								<select id="role_id" style="width:150px"
						name="role_id">
