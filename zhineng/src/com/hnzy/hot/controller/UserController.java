...
//		JSONObject jsonObject=new JSONObject();
	...
	public JSONObject addYh(HttpServletRequest request,String username,String password,String type) throws UnsupportedEncodingException{
		 username=new String(username.getBytes("ISO-8859-1"),"utf-8");
    	...
    	public JSONObject getRole() throws UnsupportedEncodingException{
    		JSONObject jsonObject= new JSONObject();   		
    		jsonObject.put("list", userServer.getRole());
    		return jsonObject;
    	}
    	
    	@ResponseBody
    	@RequestMapping("/getPermission")
    	public JSONObject getPermission() throws UnsupportedEncodingException{
    		JSONObject jsonObject= new JSONObject();   		
    		jsonObject.put("list", userServer.getPermission());
    		return jsonObject;
    	}
    	
    	@ResponseBody
    	@RequestMapping("/getRole_Per")
    	public JSONObject getRole_Per(String id) throws UnsupportedEncodingException{
    		JSONObject jsonObject= new JSONObject();   		
    		jsonObject.put("list", userServer.getRole_Per(id));
    		return jsonObject;
    	}
    	@ResponseBody
    	@RequestMapping("/getRoleIdByName")
    	public JSONObject getRoleIdByName(String name) throws UnsupportedEncodingException{
    		JSONObject jsonObject= new JSONObject();   		
    		jsonObject.put("id", userServer.getRoleIdByName(getUtf8(name)));
    		return jsonObject;
    	}
    	...
    	@ResponseBody
    	@RequestMapping("/UpdateRole_Per")
    	public JSONObject UpdateRole_Per(String[] per_id,String role_id) throws UnsupportedEncodingException{
    		JSONObject jsonObject= new JSONObject();   		
    		userServer.deleteRole_Per(role_id);
    		if(per_id!=null){
    			for (int i = 0; i < per_id.length; i++) {
        			userServer.InsRole_Per(role_id, per_id[i]);
    			}
    		}
