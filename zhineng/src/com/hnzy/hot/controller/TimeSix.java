...
//			}
			...
			}else if(xqName.equals("天鹅堡")||xqName.equals("联通小区")||xqName.equals("越海华府")){
			...
			DYH=(String) yhList.get(i).get("CellNO").toString();
			...
			if(xqName.equals("三和铝厂")){
				...
				if(xqName.equals("滨溪花园")){
					xqName="滨溪花园(智慧供热区域）";
					if(LH.equals("11#")||LH.equals("12#")||LH.equals("13#")){
						LH=LH+"（ptf）";
					}
				}
//				 jf =jfService.findJfxx("滨溪花园(智慧供热区域）", "1#", "1", "202");
				 jf =jfService.findJfxx(xqName, LH, DYH, hh);
				 if(xqName.equals("滨溪花园(智慧供热区域）")){
						xqName="滨溪花园";
					}
			}
			DataSourceContextHolder.setDbType(DataSourceType.dse);
