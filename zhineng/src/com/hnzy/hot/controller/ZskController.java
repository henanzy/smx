...
public class ZskController {
	...
	@ResponseBody
	public JSONObject selUser() throws UnsupportedEncodingException{
		
		JSONObject jsonObject=new JSONObject();
		List<Map<String, Object>> yhlbs=zskService.selUser();
		jsonObject.put("list",yhlbs);
		return jsonObject;
	}
	...
	public String updateUser(String id,String role_id) {

		Map<String, Object> map =new HashMap<>();
		map.put("id", id);
		map.put("role_id", role_id);
		zskService.updateUser(map);
		return "ZhiNeng/role";
	}
}
