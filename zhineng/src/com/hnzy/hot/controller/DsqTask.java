...
public class DsqTask {
	...
	int JzqPort = 0;
	// 日志文件
	private static Log log = LogFactory.getLog(DsqTask.class);
	
	public void doSomething() throws SQLException {
		System.out.println("-------定时执行1-------");
		//连接数据库
		...
		String sqlcx = "select distinct T_JzqInfo.JzqID,T_QgInfo.QgID from T_JzqInfo,T_QgInfo where T_JzqInfo.JzqID=T_QgInfo.JzqID and (QgFl=0 or QgFl=2) and T_JzqInfo.JzqID>='47200051'  order by T_QgInfo.QgID";
	...
	public void doSomethingS() throws SQLException {
