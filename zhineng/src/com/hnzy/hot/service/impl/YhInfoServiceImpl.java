...
public class YhInfoServiceImpl implements YhInfoService{
	...
	@Override
	public List<Map<String, String>> findHistory(String xqName, Integer buildNo, Integer cellNo, Integer HouseNo,
			String startTime, String endTime) {
		// TODO Auto-generated method stub
		return yhnfoDao.findHistory(xqName, buildNo, cellNo, HouseNo, startTime, endTime);
	}

	@Override
	public List<Map<String, String>> findHistoryTop(String xqName, Integer buildNo, Integer cellNo, Integer HouseNo,
			String startTime, String endTime) {
		// TODO Auto-generated method stub
		return yhnfoDao.findHistoryTop(xqName, buildNo, cellNo, HouseNo, startTime, endTime);
	}

	@Override
	public void updateYhlb(Map<String, Object> map) {
		// TODO Auto-generated method stub
		 yhnfoDao.updateYhlb(map);
	}
