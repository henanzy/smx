...
public interface YhInfoService {
	...
	//查找历史数据
	public List<Map<String,String>> findHistory(@Param("xqName")String xqName,@Param("buildNo")Integer buildNo,@Param("cellNo")Integer cellNo,@Param("HouseNo")Integer HouseNo,String startTime,String endTime);
	//查找历史数据
